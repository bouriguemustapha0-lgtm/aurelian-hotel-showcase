  ...
  head: () => ({
    meta: [
      ...
      { title: "Maison Aurelle — Luxury Hotel & Resort" },
      {
        name: "description",
        content:
          "Maison Aurelle is a five-star sanctuary of warm light, gold detail and quiet luxury. Explore signature suites, world-class amenities and curated experiences.",
      },
      { property: "og:title", content: "Maison Aurelle — Luxury Hotel & Resort" },
      {
        property: "og:description",
        content: "A five-star sanctuary of warm light, gold detail and quiet luxury.",
      },
